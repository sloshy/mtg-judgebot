...
const manifest = [
  // How it works
  {
    src: "docs/EXPLAINER.md",
    dest: "how-it-works/explainer-1-what-and-why.md",
    title: "Explainer 1: What it does and why",
    order: 1,
    sections: [1, 3],
    description:
      "What the judge does, why a bare model is not enough, and one question end to end.",
    lead: "The first of four parts of `docs/EXPLAINER.md`, an end-to-end tour for a programmer new to retrieval-augmented systems.",
  },
  {
    src: "docs/EXPLAINER.md",
    dest: "how-it-works/explainer-2-data-and-retrieval.md",
    title: "Explainer 2: Data and retrieval",
    order: 2,
    sections: [4, 6],
    description:
  ...
  {
    src: "docs/EXPLAINER.md",
    dest: "how-it-works/explainer-3-failure-feedback-money.md",
    title: "Explainer 3: Failure, feedback and money",
    order: 3,
    sections: [7, 10],
    description:
  ...
  {
    src: "docs/EXPLAINER.md",
    dest: "how-it-works/explainer-4-providers-eval-technology.md",
    title: "Explainer 4: Providers, evaluation, technology",
    order: 4,
    sections: [11, 15],
    description:
      "Models as configuration, the gold-set evaluation, what each technology buys, and a glossary.",
    lead: "The last part of the explainer.",
  },
  {
    src: "docs/ARCHITECTURE.md",
    dest: "how-it-works/architecture.md",
    title: "Architecture",
    order: 5,
  ...
  },
  {
    ...
    dest: "how-it-works/decisions.md",
  ...
  },
  {
    ...
    dest: "how-it-works/providers.md",
  ...
  {
    src: "README.md",
    dest: "how-it-works/evaluation.md",
    title: "Evaluation",
    order: 8,
    between: ["## Evaluation", "## Design"],
  ...
  {
    src: "CONTRIBUTING.md",
    dest: "contributing/development.md",
    title: "Development setup and gates",
    order: 1,
    description:
      "Environment, the CI gates, SQL and prompt change procedures, and the design rules.",
  },
  // Reference
  {
    src: "CHANGELOG.md",
...
function frontmatter(e) {
  ...
  if (e.badge)
    sidebar.push(`  badge:`, `    text: ${JSON.stringify(e.badge)}`, `    variant: note`);
...
for (const e of manifest) {
  ...
  let body = e.sections
    ? sections(raw, e.sections)
    : e.between
      ? between(raw, e.between)
      : stripH1(raw);
